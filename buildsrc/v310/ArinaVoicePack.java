...
/**
 * Bundled local Arina voice core v2.
 *
 ...
 * and alarm phrases then work offline. Android TTS remains the fallback for
 * dynamic phrases that are not yet represented by the local grammar.
 */
public final class ArinaVoicePack {
    private static final String TAG = "ArinaVoicePack";
    private static final String ASSET = "arina_core_v2.zip";
    private static final String DIR = "arina_voice_core_v2";
    private static final String MARKER = ".installed_v2";
        ...
        synchronized (INSTALL_LOCK) {
            ...
            try (InputStream raw = context.getAssets().open(ASSET);
                ...
                try (FileOutputStream out = new FileOutputStream(marker)) {
                    out.write("Somnori Arina core v2\n".getBytes(java.nio.charset.StandardCharsets.UTF_8));
                }
            } catch (Exception e) {
